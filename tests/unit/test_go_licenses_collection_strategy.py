...
def test_go_licenses_collection_strategy_clones_and_run_go_license_on_init(mocker):
    ...
    get_cwd_mock = mocker.patch("os.getcwd", return_value="test_cwd")
    ...
    # assert that the temporary directory was cleaned up
    temp_dir_object.cleanup.assert_called_once()

    assert strategy.temp_dir is None
...
def test_go_licenses_collection_strategy_do_not_miss_or_replace_non_go_packages(mocker):
    ...
    mocker.patch("os.getcwd", return_value="test_cwd")
