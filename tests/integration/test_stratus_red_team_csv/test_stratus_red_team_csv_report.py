...
from src.metadata_collector.strategies.github_sbom_collection_strategy import (
    GitHubMetadataCollectionStrategy,
)
...
def test_stratus_red_team_csv_report():
    ...
    metadata_collector = MetadataCollector(
        [GitHubMetadataCollectionStrategy("github_token")]
    )
    metadata = metadata_collector.collect_metadata(
    ...
    with open(
        "tests/integration/test_stratus_red_team_csv/expected_stratus_report.csv", "r"
    ) as f:
