...
In some cases, our tool will not be able to extract a particular dependency information, or the information will not be available in the dependency itself to extract.
